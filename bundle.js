...
async function dumpTracks() {
	...
	data.recenttracks.track.forEach(function (skv_track) {
		...
		str_html += '<li>' + '<img src="' + img_src + '">' + ' <a href="' + skv_track.url.replace(/_\/.+$/, '') + '">' + skv_track.artist['#text'] + '</a>' + ' - ' + '<a href="' + skv_track.url + '">' + skv_track.name + '</a></li>';
	});
...
async function getRecentTracks(lastfm_user) {
	...
	return $.ajax({
		...
		fail: function fail(xhr, type, exception) {
...
function template(locals) {var pug_html = "", pug_mixins = {}, pug_interp;pug_html = pug_html + "\u003Ch1\u003EWebPack Games\u003C\u002Fh1\u003E\u003Cp\u003EWebPack is not yet fun but might be when I figure out how it works\u003C\u002Fp\u003E";;return pug_html;};
